...
plot(mtcars$wt, mtcars$mpg,
     xlab = "Weight (1,000 lbs)", ylab = "MPG",
...
plot(mtcars$mpg, mtcars$hp,
     ...
     main = "Tallen's Scatterplot")

hist(mtcars$qsec,
     xlab = "1/4 Mile Time (qsec)", ylab = "Count",
     main = "Vlad's Histogram")

# NOTE this has been corrected since we met in class
boxplot(qsec ~ am, data = mtcars,
        xlab = "Transmission Type", ylab = "Time to 1/4 mi",
        main = "Calvin's Boxplot")
```
